...
namespace copper::components {
    ...
    std::string cipher_encrypt(
        ...
        auto *output_buffer = new unsigned char[input.size() + EVP_CIPHER_block_size(EVP_aes_256_cbc())];
    ...
    std::string cipher_decrypt(
        ...
        int length;
        int input_length;
        auto *input_buffer = new unsigned char[input.size() + EVP_CIPHER_block_size(EVP_aes_256_cbc())];
